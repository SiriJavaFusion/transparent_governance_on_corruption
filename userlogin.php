...
<body style="background-size: cover;
    background-image: linear-gradient(to right ,powderblue,black );
  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>Complaint Portal</b></a></li>
        <li class="active" style="margin-top: 1%;"><a href="userlogin.php">Complainer Login</a></li>
      </ul>
